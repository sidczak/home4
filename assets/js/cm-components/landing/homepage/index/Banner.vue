            ...
            .banner__wrapper-pulse
                ...
                .banner__wrapper
                    ...
                    .banner__ring-wrapper
                        ...
                        WebinarFlywheel(isMulti, isBanner, prefix="index.banner")
</template>

<script>
import WebinarFlywheel from '../webinar-flywheel/WebinarFlywheel.vue'
...
$wrapperLeftBg: #1c2b5a;
$wrapperRightBg: #1e377e;
$pulseBorder: #e5e7f0;
...
.banner {
    ...
    &__wrapper {
        background: $wrapperLeftBg;
        background: linear-gradient(to right, $wrapperLeftBg 0%, $wrapperRightBg 100%);
        border-radius: 20px;
        padding: 55px 65px;
    ...
    &__ring-pulse-2,
    &__ring-pulse-3 {
        border: 2px solid $pulseRingBorder;
        position: absolute;
        top: 50%;
        transform: translateY(-50%);
        bottom: 0;
    ...
    .btn-discover-scenario {
        background-color: $btnDiscoverScenario;
        color: $white;
        font-size: .9375rem;
        font-weight: 500;
        padding:  13px 15px;
        ...
        position: relative;
        &:hover {
            background-color: darken( $btnDiscoverScenario, 5% );
        }
    }
}
</style>
