 ...
 */
final class Version20211030212403 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE blog_comment (id INT AUTO_INCREMENT NOT NULL, post_id INT NOT NULL, username VARCHAR(50) NOT NULL, author_email VARCHAR(50) NOT NULL, website VARCHAR(255) DEFAULT NULL, content LONGTEXT NOT NULL, is_approved TINYINT(1) DEFAULT \'1\' NOT NULL, published_at DATETIME NOT NULL, INDEX IDX_7882EFEF4B89032C (post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE blog_post (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, excerpt LONGTEXT DEFAULT NULL, content LONGTEXT NOT NULL, author_email VARCHAR(255) NOT NULL, status_post VARCHAR(20) DEFAULT \'publish\' NOT NULL, show_comment TINYINT(1) DEFAULT \'1\' NOT NULL, enable_comment TINYINT(1) DEFAULT \'1\' NOT NULL, views_post INT DEFAULT NULL, published_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_BA5AE01D2B36786B (title), UNIQUE INDEX UNIQ_BA5AE01D989D9B62 (slug), INDEX IDX_BA5AE01D12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
